...
def main():
    ...
    badguy = BadguySprite(image=game_images.get('badguy'), position=(640, 100))
    ...
    while running:
        ...
        for x in range(cfg.SCREENSIZE[0] // game_images['grass'].get_width() + 1):
            for y in range(cfg.SCREENSIZE[1] // game_images['grass'].get_width() + 1):
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                arrow = ArrowSprite(game_images.get('bullet'), (angle, bunny.rotated_position[0] + 32, bunny.rotated_position[1] + 26))
        ...
        if badtimer == 0:
            ...
            badtimer1 = 20 if badtimer >= 20 else badtimer1 + 2
        badtimer -= 1
